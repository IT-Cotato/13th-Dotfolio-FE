...
export const MemoDeleteToast = ({ onClose, onUndo }: MemoDeleteToastProps) => {
  ...
  return (
    <div
      role="status"
      aria-live="polite"
      className="fixed left-1/2 top-[17px] z-[90] inline-flex -translate-x-1/2 items-center gap-2.5 whitespace-nowrap rounded-[100px] bg-white px-4 py-3 text-body2-md text-grey-900 shadow-[0_0_30px_rgba(22,53,164,0.08)]"
    >
